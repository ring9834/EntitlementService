...
namespace EntitlementService.Services
{
    public class SeedService : ISeedService
    {
        ...
        public SeedService(INeo4jDataAccess dataAccess) => _dataAccess = dataAccess;
        ...
        public async Task SeedAsync()
        {
            var seedCypher = """
                ...
                MERGE (custProxy:Customer {id: 'cust-proxy', clearanceLevel: 1})
            ...
            await _dataAccess.ExecuteWriteAsync(seedCypher, new { });
        }
    }
}
